!function(e){
	...
	void 0!==o&&null!=o&&google.maps.event.addDomListener(document.getElementById("load-more-button"),"click",function(){
...
//	    	a.concat([o(b[0][0],b[0][1],b[0][2],b[0][3],b[0][4],b[0][5],b[0][6],b[0][7]),b[1][0], b[1][1],(i+1),n]);
		...
		void 0!==a&&null!=a&&google.maps.event.addDomListener(document.getElementById("load-more-button"),"click",function(){
...
//	    	locations.push([locationData(JSON.stringify(b[0])),b[1][0], b[1][1],(i+1),markerIcon]);
    ...
    if (typeof (map) != 'undefined' && map != null) {
        google.maps.event.addDomListener(document.getElementById("load-more-button"),"click",mainMap);
    }
    function singleMap() {
        var myLatLng = {
    ...
    if (typeof (single_map) != 'undefined' && single_map != null) {
        google.maps.event.addDomListener(document.getElementById("load-more-button"),"click",singleMap);
    }
})(this.jQuery);