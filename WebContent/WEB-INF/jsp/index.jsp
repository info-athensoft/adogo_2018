                        ...
                        <div class="hero-section-wrap fl-wrap">
                            <div class="container">
                                <div class="intro-item fl-wrap">
                                    <h2>Adogo New Advertising and Branding</h2>
                                    <h3>we are helping connect life and business</h3>
                                </div>
                                    ...
                                    <div class="main-search-input fl-wrap">
                                        ...
                                        <div class="main-search-input-item">
                                            <select data-placeholder="All Categories" class="chosen-select" >
                                                ...
                                                <option>View Full Categories</option>
                                            </select>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="color-bg-text">
                                        <h3>Next generation searching</h3>
