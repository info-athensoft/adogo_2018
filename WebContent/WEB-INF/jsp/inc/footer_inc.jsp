                            ...
                            <div class="footer-widget fl-wrap">
                                ...
                                <div class="footer-contacts-widget fl-wrap">
                                    ...
                                    <ul  class="footer-contacts fl-wrap">
                                        <li><span><i class="fa fa-envelope-o"></i> Mail :</span><a href="#" target="_blank">support@adogo.ca</a></li>
                                        <li> <span><i class="fa fa-map-marker"></i> Adress :</span><a href="#" target="_blank">USA 27TH Brooklyn NY</a></li>
                                        <li><span><i class="fa fa-phone"></i> Phone :</span><a href="#">+1 (514)800-2956</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="sub-footer fl-wrap">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="copyright"> &#169; Adogo - Informatique Athensoft 2018 .  All rights reserved.</div>
                            </div>
                            <div class="col-md-4">
