...
<c:set var="image_gallery_dir" value="/images/advertiser/cust_id/booth_gallery"/>
<c:set var="image_banner_dir" value="/images/advertiser/cust_id/booth_banner"/>
<!-- END page variables -->
                    ...
                    <div class="list-single-carousel-wrap fl-wrap" id="sec1">
                        <div class="fw-carousel fl-wrap full-height lightgallery">
                            ...
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="${image_gallery_dir}/1.jpg"   alt="">
                                    <a href="${image_gallery_dir}/1.jpg" class="gal-link popup-image"><i class="fa fa-search"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="${image_gallery_dir}/2.jpg"   alt="">
                                    <a href="${image_gallery_dir}/2.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                            <!-- slick-slide-item -->
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="${image_gallery_dir}/3.jpg"   alt="">
                                    <a href="${image_gallery_dir}/3.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                            <!-- slick-slide-item -->
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="${image_gallery_dir}/4.jpg"   alt="">
                                    <a href="${image_gallery_dir}/4.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                            <!-- slick-slide-item -->
                            <div class="slick-slide-item">
                                <div class="box-item">
                                    <img  src="${image_gallery_dir}/5.jpg"   alt="">
                                    <a href="${image_gallery_dir}/5.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                </div>
                            </div>
                            <!-- slick-slide-item end -->
                        </div>
                                                ...
                                                <div class="list-single-header-item">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            ...
                                                            <h2>J Design Studio <span> - Hosted By </span><a href="author-single.html">Jovy</a> </h2>
